...
import com.yang.kafka.demo.Constants;
import com.yang.kafka.demo.IpranAlarm;
...
public class KafkaUtils {
    ...
    public static void sendMsgToKafka(IpranAlarm msg) {
        producer.send(new ProducerRecord<String, String>(Constants.TOPIC_NAME, String.valueOf(System.currentTimeMillis()),
