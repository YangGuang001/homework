 ...
 *
 */
public class HystrixCommandThreadPool extends HystrixCommand<String> {
    private String name;

    public HystrixCommandThreadPool(String name) {
...
//	        		System.out.println("===========" + new HystrixCommand4ThreadPoolTest("Hlx").execute());
                    Future<String> future = new HystrixCommandThreadPool("Hlx"+i).queue();
//	        		System.out.println("===========" + future.get());
            ...
            for(int i = 0; i < 20; i++) {
                try {
                    //        		assertEquals("fallback: Hlx", new HystrixCommand4ThreadPoolTest("Hlx").execute());
                    System.out.println("===========" + new HystrixCommandThreadPool("Hlx" ).execute());
